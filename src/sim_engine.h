...
namespace hfut {
    ...
    private:
         ...
         * \param circuit_diff the energy of the current Polarization
         * \param neighbour_diff the energy of the neighbour Polarization
         */
        ...
        long double  output_diff;//!< the energy of the non input cells
        Polarization neighbour_p;//!< the neighbour polarization generated by neighbour method
        long double  neighbour_diff;//!< the energy of the neighbour polarization
