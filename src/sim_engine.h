...
namespace hfut {
    ...
    public:
         ...
         */
        virtual void run_simulation(const PolarizationList &input_p);
    ...
    protected:
         ...
         */
        void set_input_polarization(const PolarizationList &input_p) const;
    ...
    private:
         ...
         */
        long double compute_polarization_energy(const PolarizationList &output_p) const;
        ...
        //run time states
        PolarizationList input_p;//!< input cells's polarizations
        PolarizationList output_p;//!< normal and output cells' polarizations
        long double  output_energy;//!< the energy of the non input cells
        PolarizationList neighbour_p;//!< the neighbour polarization generated by neighbour method
        long double  neighbour_energy;//!< the energy of the neighbour polarization
        PolarizationList best_p;//!< the currently best polarization
